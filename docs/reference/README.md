...
- [Little Kitchen Pal](codeniu/cook-like-hoc/README.md) — an entirely offline recipe reference: 340 recipes with 177 photographs and three CJK font subsets embedded in the firmware, with a random-dish draw and a browsable list. [User guide](codeniu/cook-like-hoc/USER_GUIDE.md) covers the button actions, settings, and known limits; [changelog](codeniu/cook-like-hoc/CHANGELOG.md) records what changed and when.
