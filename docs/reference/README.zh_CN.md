...
- [小厨宝](codeniu/cook-like-hoc/README.zh_CN.md) — 完全离线的菜谱参考应用：340 道菜、177 张实拍封面与三个中文字体子集内嵌固件，含随机推荐与可翻阅列表。[使用说明](codeniu/cook-like-hoc/USER_GUIDE.zh_CN.md) 覆盖按键操作、设置项与已知限制，[更新日志](codeniu/cook-like-hoc/CHANGELOG.zh_CN.md) 记录每次改动。
